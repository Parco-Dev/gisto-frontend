...
<template>
  <div class="icon-folder">
    ...
    <svg v-if="isOpen" id="Livello_1" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 16.1 11.4" style="enable-background:new 0 0 16.1 11.4;" xml:space="preserve">
      <g>
        <g id="Raggruppa_99">
    ...
    <svg v-else id="Livello_1" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 13.4 11.4" style="enable-background:new 0 0 13.4 11.4;" xml:space="preserve">
      <g>
        <g id="Raggruppa_100">
          <path
            id="Tracciato_50" class="st0" d="M13,1.1H4.3L3.9,0.3C3.8,0.1,3.6,0,3.5,0H1C0.8,0,0.6,0.1,0.6,0.3L0,1.3l0,0
